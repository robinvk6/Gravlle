...
<html lang="en">
	<head>
		...
		<link href="/resources/css/smoothness/jquery-ui.custom.min.css" rel="stylesheet" media="screen">
		<style>
			/* overriding jquery ui button marings */
	...
	<body>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
						...
						<table id="directory" class="table table-hover">
							...
							<tbody>
								<c:forEach items="${families}" var="family" varStatus="loop">
									<tr>
									<c:set var="longKey" value="${family.familyId}"/>
										<td>${family.familyName} & Family
										<div style="display:none">${familyMap.get(longKey)}</div>
										</td>										
			...
			<script type="text/javascript" src="/resources/js/jquery-ui-1.10.2.custom.min.js"></script>
