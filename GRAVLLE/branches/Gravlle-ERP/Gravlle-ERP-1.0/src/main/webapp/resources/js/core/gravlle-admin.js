var GRAVLLE_ERP = {
    ...
    gravlleLogger: function(option) {
        ...
        debugger;
        var logType = option || this.noGo();
        logType = this.gravlleLogging && option.logType || 'console';
...
var GRAVLLE_CATEGORY_TREE = {
    ...
    buildCategoryList : function() {
        ...
        if( categoryListArray.length != 0 ) {
            ...
            categoryListBody = '<div class="form-group"><a href="javascript:;" onclick="invokeProductDetailPage();" class="btn blue button-next">Create Product<i class="m-icon-swapright m-icon-white"></i></a></div>';
        }
